        ...
        case 'slashing':
            new Sequence()
                ...
                .effect()
                    ...
                    .rotateTowards(targetToken)
                    .mirrorY()
                    .spriteOffset({x: -0.4 * sourceToken.width}, {gridUnits: true})
        ...
        case 'bludgeoning':
            new Sequence()
                ...
                .effect()
                    ...
                    .rotateTowards(sourceToken)
                    .spriteRotation(180)
                    .spriteOffset({x: -0.5 * sourceToken.width, y:0}, {gridUnits: true})
                    .filter('ColorMatrix', {saturate: -1, brightness: -1 })
                    .scaleIn(0, 250, {ease: 'easeOutExpo'})
                    .zIndex(0)
                .thenDo(function(){
        ...
        default:
            new Sequence()
                ...
                .effect()
                    ...
                    .spriteRotation(15)
                    .mirrorY()
                    .spriteOffset({x: -0.9 * sourceToken.width, y:-0.3 * sourceToken.width}, {gridUnits: true})
                    .filter('ColorMatrix', {saturate: -1, brightness: -1 })
                    .rotateIn(-25, 250, {ease: 'easeOutExpo'})
                    .zIndex(0)
                .thenDo(function(){
