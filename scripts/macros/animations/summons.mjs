...
async function defaultAnimation(summon, location, token) {
    ...
    const sound = summon.sounds.place;
...
async function celestial(summon, location, token) {
    const image = token.texture.src;
    const imageSize = token.width * token.texture.scaleX;
    const sound = summon.sounds.place;
    /* eslint-disable indent */
...
async function fiend(summon, location, token) {
    const image = token.texture.src;
    const imageSize = token.width * token.texture.scaleX;
    const sound = summon.sounds.place;
    /* eslint-disable indent */
...
async function fire(summon, location, token) {
    const image = token.texture.src;
    const sound = summon.sounds.place;
    /* eslint-disable indent */
    new Sequence()
...
async function water(summon, location, token) {
    const image = token.texture.src;
    const sound = summon.sounds.place;
    /* eslint-disable indent */
    new Sequence()
...
async function air(summon, location, token) {
    const image = token.texture.src;
    const sound = summon.sounds.place;
    /* eslint-disable indent */
    new Sequence()
...
async function earth(summon, location, token) {
    const image = token.texture.src;
    const sound = summon.sounds.place;
    /* eslint-disable indent */
    new Sequence()
...
async function nature(summon, location, token) {
    const image = token.texture.src;
    const sound = summon.sounds.place;
    /* eslint-disable indent */
    new Sequence()
...
async function shadow(summon, location, token) {
    const image = token.texture.src;
    const sound = summon.sounds.place;
    /* eslint-disable indent */
    new Sequence()
...
async function smoke(summon, location, token) {
    const image = token.texture.src;
    const sound = summon.sounds.place;
    /* eslint-disable indent */
    new Sequence()
...
async function future(summon, location, token) {
    const image = token.texture.src;
    const imageSize = token.width * token.texture.scaleX;
    const sound = summon.sounds.place;
    /* eslint-disable indent */
...
function createSummon(name, macro, requirements = []) {
    return {
...
const JB2A = ['jb2a_patreon'];
export const defaultSummon = createSummon('Default', defaultAnimation, ASE_JB2A);
export const celestialSummon = createSummon('Celestial', celestial, ASE_JB2A);
export const fiendSummon = createSummon('Fiend', fiend, ASE_JB2A);
export const fireSummon = createSummon('Fire', fire, JB2A);
export const waterSummon = createSummon('Water', water, JB2A);
export const airSummon = createSummon('Air', air, ASE_JB2A);
export const earthSummon = createSummon('Earth', earth, ASE_JB2A);
export const natureSummon = createSummon('Nature', nature, JB2A);
export const shadowSummon = createSummon('Shadow', shadow, JB2A);
export const smokeSummon = createSummon('Smoke', smoke);
export const futureSummon = createSummon('Future', future);